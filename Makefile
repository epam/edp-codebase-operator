...
IMG ?= docker.io/epamedp/codebase-operator:$(VERSION)
...
manifests: controller-gen ## Generate WebhookConfiguration, ClusterRole and CustomResourceDefinition objects.
	$(CONTROLLER_GEN) rbac:roleName=manager-role crd webhook paths="./api/..." output:crd:artifacts:config=deploy-templates/crds # TODO: change ./api/... to ./... after removing additional pkg/apis folder.
