...
func (_m *Git) CheckPermissions(ctx context.Context, repo string, user *string, pass *string) bool {
...
func (_m *Git) CommitChanges(directory string, commitMsg string, opts ...git.CommitOps) error {
