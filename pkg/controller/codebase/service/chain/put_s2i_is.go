...
func (h PutS2iIs) tryToSetupS2I(c v1alpha1.Codebase) error {
	...
	if c.Spec.Lang == util.LanguageJava || c.Spec.Lang == util.LanguageGo || c.Spec.Lang == util.LanguagePython || c.Spec.Lang == util.LanguageDotnet {
		log.V(2).Info("skip creating s2i for java/go/python/dotnet langs", "name", c.Name)
		return nil
	}
