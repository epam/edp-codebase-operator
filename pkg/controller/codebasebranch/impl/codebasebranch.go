...
func (s CodebaseBranchService) Create(cr *edpv1alpha1.CodebaseBranch) {
	...
	err := s.updateStatusFields(cr, edpv1alpha1.CodebaseBranchStatus{
	...
	if jobStatus == "blue" {
		...
		s.setFailedFields(cr, edpv1alpha1.JenkinsConfiguration, "Release job was failed.")
		return
	}
}
func (s CodebaseBranchService) Update(cr *edpv1alpha1.CodebaseBranch) {

}

func (s CodebaseBranchService) Delete(cr *edpv1alpha1.CodebaseBranch) {

}

func (s CodebaseBranchService) updateStatusFields(obj *edpv1alpha1.CodebaseBranch,
	status edpv1alpha1.CodebaseBranchStatus) error {
	obj.Status = status
	err := s.Client.Status().Update(context.TODO(), obj)
	if err != nil {
...
func (s CodebaseBranchService) setFailedFields(obj *edpv1alpha1.CodebaseBranch,
