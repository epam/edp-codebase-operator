...
// +kubebuilder:rbac:groups=v2.edp.epam.com,namespace=placeholder,resources=jiraservers,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=v2.edp.epam.com,namespace=placeholder,resources=jiraservers/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=v2.edp.epam.com,namespace=placeholder,resources=jiraservers/finalizers,verbs=update
