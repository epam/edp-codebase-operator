...
func (r *ReconcileCodebaseImageStream) SetupWithManager(mgr ctrl.Manager) error {
	...
	err = ctrl.NewControllerManagedBy(mgr).
		For(&codebaseApi.CodebaseImageStream{}, builder.WithPredicates(p), builder.WithPredicates(pause)).
		Complete(r)
	if err != nil {
...
//+kubebuilder:rbac:groups=v2.edp.epam.com.edp.epam.com,namespace=placeholder,resources=codebaseimagestreams,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=v2.edp.epam.com.edp.epam.com,namespace=placeholder,resources=codebaseimagestreams/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=v2.edp.epam.com.edp.epam.com,namespace=placeholder,resources=codebaseimagestreams/finalizers,verbs=update
